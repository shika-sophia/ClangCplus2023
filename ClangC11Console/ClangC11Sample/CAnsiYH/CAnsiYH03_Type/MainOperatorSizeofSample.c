...
*@subject ŸOperator 'sizeof()' kC99YH p267lkCAnsiYH p53, p93l
*         Operator 'sizeof()': 
*         EIt returns 'int' value of how bytes the Variable given by argument 'Type' occupy in Memory.
*         EThe return-value is how bytes the Type is occuping, not the Pointer which indicate Variable of the Tyoe. kCAnsiYH p93l
...
*         => copy from kCAnsiYH05_Array\Rererence_CAnsiArray.txtl
* 
