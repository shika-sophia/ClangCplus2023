...
*@content C99YH ëÊ12èÕ FileOperation | Chapter 12 / List  -  / p419
* 
*@subject ÅüCommand Line Argument / ÉRÉ}ÉìÉhÉâÉCÉìà¯êî
*         int  main(int argc, char* argv[])
*           Ñ§ [Argument]
*             int   argc:   argument count = [Å~] not element count of argv[] = element count - 1
...
* 
*        ÅyAnnotationÅzAfter execution, Remove above setting argument for another executions.
*
...
*
*@subject ÅüExpression 'char* argv[]' -- Which Array or Pointer ? --ÅkC99YH p419Ål
