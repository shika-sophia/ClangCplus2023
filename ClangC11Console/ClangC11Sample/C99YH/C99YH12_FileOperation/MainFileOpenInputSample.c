...
*
*@subject <stdio.h>
*            └ #define FILENAME_MAX 260 //The maximum number of character as file name including directory path
*            └ #define FOPEN_MAX 20     //The maximum number which OS of user environment can open files at same time
*        [×] └ FILE*   fopen(const char* _FileName, const char* _Mode)
*            └ int     fclose(FILE* _Stream)
*            └ int     fgetc(FILE*)     // It gets 'char' one by one Byte, from Pointer of the file which has already opend by 'fopen()'.
...
*
*@subject ◆Verify to be error or not
