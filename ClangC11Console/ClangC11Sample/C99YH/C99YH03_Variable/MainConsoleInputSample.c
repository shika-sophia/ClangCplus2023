...
*          【NOTE】    [×] don't describe: Type, "=", ";" (if existed, be thrown compile error)
* 
*           [Example]  #define BUFFER_SIZE 256
* 
*@subject <stdio.h>
*            └ #define stdin  (= Standard Input) 標準入力
*            └ #define stdout
*            └ char*  fgets(char *_Buffer, int _MaxCount, FILE _Stream)
*
*@subject <stdlib.h>
*            L int    atoi(const char *_String)  文字列から int 型に変換
*            └ double atof(const char *_String)  文字列から double 型に変換
*
